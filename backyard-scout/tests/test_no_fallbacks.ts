  ...
  },
  {
    ...
    geometry: {
      rings: [[
        ...
        [-118.382685, 34.044530],
        [-118.383144, 34.044530],
        [-118.383144, 34.044247]
      ]]
    }
  }
  ...
  for (const property of TEST_PROPERTIES) {
    ...
    try {
      ...
      if (buildings.length === 0) {
        ...
        const hasEstimate = buildings.some(b =>
    ...
    try {
      ...
      if (zoning === null) {
        ...
        if (isEstimate) {
          ...
          console.log(`   Zone: ${zoning.zone_code}`);
          if (zoning.setbacks) {
            console.log(`   Setbacks: F${zoning.setbacks.front}' S${zoning.setbacks.side}' R${zoning.setbacks.rear}'`);
          }
        }
      }
    } catch (error: any) {
