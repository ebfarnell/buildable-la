...
function validateFromDB() {
  ...
  console.log(
    `   - Match: ${Math.abs(calculatedParcelArea - row.lot_area_sqft) < 1 ? '✅' : '❌'}\n`,
  );
  ...
  console.log(
    `   - Match: ${Math.abs(calculatedBuildableArea - row.buildable_footprint_sqft) < 1 ? '✅' : '❌'}\n`,
  );
  ...
  console.log(
    `Lot:       ${'█'.repeat(Math.round(calculatedParcelArea / scale))} (${calculatedParcelArea.toFixed(0)} sqft)`,
  );
  console.log(
    `Buildings: ${'█'.repeat(Math.round(totalFootprintArea / scale))} (${totalFootprintArea.toFixed(0)} sqft)`,
  );
  console.log(
    `Buildable: ${'█'.repeat(Math.round(calculatedBuildableArea / scale))} (${calculatedBuildableArea.toFixed(0)} sqft)`,
  );
